...
public class PolicyRuleResponse {
    ...
    public PolicyRuleResponse(Long id, Long policyId, String ruleKey, ClassLabel appliesToLabel,
    ...
    public static class Builder {
        ...
        public PolicyRuleResponse build() {
            return new PolicyRuleResponse(id, policyId, ruleKey, appliesToLabel, domainPattern,
